...
public class SecondPortalShot : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            GameObject portal = Instantiate(secondPortalPrefab, new Vector3(transform.position.x, transform.position.y -1.0f, transform.position.z), other.transform.rotation);
